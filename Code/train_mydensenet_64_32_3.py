...
parser.add_argument('--model_dir', default='C:\\Users\\rsbandhu\\Documents\\MUSTBACKUP\\Details\\Computers\\DeepLearning_Stanford_CS230\\CS230_Protein_Atlas_Classification\\Code\\models\\Densenet169',help="Directory of the params.json file under models dir")
parser.add_argument('--log_dir', default='C:\\Users\\rsbandhu\\Documents\\MUSTBACKUP\\Details\\Computers\\DeepLearning_Stanford_CS230\\CS230_Protein_Atlas_Classification\\Code\\Experiments\\expt29',help="Directory of the logs and saved model weights")
'''
...
def train(model, optimizer, loss_fn, dataloader, metrics, params, img_count, threshold, cuda_present):
    ...
    for i, (train_batch, labels_batch) in enumerate(dataloader):
        ...
        loss_prim =loss_fn(prim_out, labels_batch,loss_class_wts)  #each class a different weight
        #loss_prim =loss_fn(prim_out, labels_batch,loss_pos_wts) # within each class postive sampes have a unique diff weight
...
def train_and_evaluate(model, params, dataloader, optimizer, scheduler, loss_fn, metrics, model_dir, log_dir, threshold, cuda_present):
    ...
    for epoch in range(params.num_epochs):
        ...
        chk_file_name = 'train_DN73_3ch_RGB_nodataaug_Adam__'+'epoch_'+str(epoch)+'__'
...
if __name__ == "__main__":
    ...
    # Set the logger
    utils.set_logger(os.path.join(log_dir, 'train_DN73_3ch_RGB_nodataaug_Adam.log'))
    logging.info('New Simulation, first line in main, train_mydensenet_64_32_3.py') 
    logging.info('BCEWithLogitsLoss, weights = 1/log(N_i) per class, input 3 channels RBG, Adam, dataset = train_224_new')
    ...
    for t in range(1):
        ...
        logging.info("model name : net.mydensenet_64_32_3_inputchan_RBG, Adam")
