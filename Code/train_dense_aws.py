...
def train_and_evaluate(params, train_dataloader, optimizer, loss_fn, metrics, model_dir, threshold, cuda_present):
    ...
    for epoch in range(params.num_epochs):
        ...
        train(model, optimizer, loss_fn, data_generator, metrics, params, img_count, threshold, cuda_present)
...
if __name__ == "__main__":
    ...
    # Set the logger
    utils.set_logger(os.path.join(args.model_dir, 'train_1.log'))
    ...
    for t in range(5):
        ...
        train_and_evaluate(params, dataloader, optimizer, loss_fn, metrics, model_dir, threshold, cuda_present)
